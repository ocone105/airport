...
<body>
	<div class="home">
		<div class="background_image"
			style="background-image: url(/airport/resources/images/contact.jpg)">
		</div>
	</div>
			...
			<div class="row">
				<div class="col">
					<div class="home_search_container">
						<h3 style="color: white; text-align: center;">Sign in &amp; Sign up</h3>
					</div>
				</div>
			</div>
								...
								<div class="form-box">
									...
									<div class="form-bottom">
										<form role="form" action="" method="post"
											...
											<p>Receive 알림 받기</p>
											<div class="form-group">
												<label class="sr-only" for="form-alarm">Check</label>
												<p>
													Email: <input type="checkbox" name="form-email-check"
														id="form-email-check">
												</p>
												<p>
													Phone: <input type="checkbox" name="form-phone-check"
														id="form-phone-check">
												</p>
											</div>
