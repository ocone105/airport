					...
					<div class="col-md-12">
						<div class="card-body">
							...
							<div class="row" style="text-align: center;">
								<img src="/airport/resources/images/unjoin.png"><br/>
								<p style="font-size: 24px;">회원탈퇴를 원하시면 비밀번호를 한번 더 입력하시기
									바랍니다.</p>
								<p style="font-size: 20px;">탈퇴 후에는 새로 회원가입을 하셔야 서비스 이용이
									가능합니다.</p>
							</div>
							<div style="text-align: center;">
								<p>
									<input style="width: 400px; height: 50px;" type="password"
