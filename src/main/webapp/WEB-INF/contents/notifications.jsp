...
<script src="/airport/resources/common/js/plugins/bootstrap-notify.js"></script>
</head>
<body>
	<
	<div class="content">
						...
						<div class="col-md-6">
							...
							<div class="alert alert-info alert-with-icon"
								...
								<span data-notify="message">This is a notification with
									...
									icon and the close button are always vertically aligned. This
									is a beautiful notification. So you don't have to worry about
									the style.</span>
							</div>
						</div>
						<div class="col-md-6">
