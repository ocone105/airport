...
<body>
	<!-- Footer -->
 	<footer class="footer">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="/airport/resources/images/footer_1.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<div class="row">
						...
						<div class="col-xl-4 footer_contact_col">
							<div class="footer_contact_item d-flex flex-column align-items-center justify-content-start text-center">
								<div class="footer_contact_icon"><img src="/airport/resources/images/sign.svg" alt=""></div>
						...
						<div class="col-xl-4 footer_contact_col">
							<div class="footer_contact_item d-flex flex-column align-items-center justify-content-start text-center">
								<div class="footer_contact_icon"><img src="/airport/resources/images/trekking.svg" alt=""></div>
						...
						<div class="col-xl-4 footer_contact_col">
							<div class="footer_contact_item d-flex flex-column align-items-center justify-content-start text-center">
								<div class="footer_contact_icon"><img src="/airport/resources/images/around.svg" alt=""></div>
		...
		All rights reserved |<a href="/airport/main/privacy" style="font-weight: bold;">개인정보처리방침</a>
		|<a href="/airport/main/email" style="font-weight: bold;">이메일무단수집거부</a>|
