					...
					<div class="card-body">
							...
							<div class="tab-content pl-3 pt-2" id="nav-tabContent">
								<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
									<div id="map1" style="width: 1005px; height: 700px; margin-top: 100px"></div>
								</div>
								<div class="tab-pane fade active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
									<div id="map2" style="width: 1005px; height: 700px; margin-top: 100px"></div>
								</div>
							</div>
										...
										var positions = [
												{
													content : '<div>GATE1<div>',
													latlng : new daum.maps.LatLng(
															37.467625, 126.435449)
												},
												{
													content : '<div>GATE2<div>',
													latlng : new daum.maps.LatLng(
															37.467080, 126.434331)
												}
										];
