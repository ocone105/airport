...
<body>
	...
	<div class="about">
		<div class="container">
			...
			<div class="row about_row">
				...
				<div class="col-lg-6">
					<div class="about_image"><img src="/airport/resources/images/about_1.jpg" alt=""></div>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/airport/resources/images/mountain.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/airport/resources/images/island.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/airport/resources/images/camera.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/airport/resources/images/boat.svg" alt=""></div>
	...
	<div class="why">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="/airport/resources/images/why.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_subtitle">simply amazing places</div>
			...
			<div class="row why_row">
				...
				<div class="col-lg-4 why_col">
					<div class="why_item">
						<div class="why_image">
							<img src="/airport/resources/images/why_1.jpg" alt="">
							<div class="why_icon d-flex flex-column align-items-center justify-content-center">
								<img src="/airport/resources/images/why_1.svg" alt="">
							</div>
						</div>
				...
				<div class="col-lg-4 why_col">
					<div class="why_item">
						<div class="why_image">
							<img src="/airport/resources/images/why_2.jpg" alt="">
							<div class="why_icon d-flex flex-column align-items-center justify-content-center">
								<img src="/airport/resources/images/why_2.svg" alt="">
							</div>
						</div>
						<div class="why_content text-center">
				...
				<div class="col-lg-4 why_col">
					<div class="why_item">
						<div class="why_image">
							<img src="/airport/resources/images/why_3.jpg" alt="">
							<div class="why_icon d-flex flex-column align-items-center justify-content-center">
								<img src="/airport/resources/images/why_3.svg" alt="">
							</div>
						</div>
						<div class="why_content text-center">
			...
			<div class="row team_row">
				...
				<div class="col-xl-3 col-md-6 team_col">
					<div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
						<div class="team_image"><img src="/airport/resources/images/team_1.jpg" alt=""></div>
				...
				<div class="col-xl-3 col-md-6 team_col">
					<div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
						<div class="team_image"><img src="/airport/resources/images/team_2.jpg" alt=""></div>
						<div class="team_content">
				...
				<div class="col-xl-3 col-md-6 team_col">
					<div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
						<div class="team_image"><img src="/airport/resources/images/team_3.jpg" alt=""></div>
						<div class="team_content">
				...
				<div class="col-xl-3 col-md-6 team_col">
					<div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
						<div class="team_image"><img src="/airport/resources/images/team_4.jpg" alt=""></div>
						<div class="team_content">
